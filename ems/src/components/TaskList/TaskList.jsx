...
function TaskList() {
  return (
    <div id='tasklist' className='h-[50%] overflow-x-auto flex items-center justify-start gap-5 flex-nowrap w-full py-1 mt-16'>
        <div className='flex-shrink-0 h-full w-[300px] p-5 bg-gray-400 rounded-2xl font-sans'>
        <div className='flex justify-between items-center'>
            <h3 className='bg-green-400 text-sm border-gray-500 border-2  text-black font-bold px-3 py-1 rounded'>High</h3>
